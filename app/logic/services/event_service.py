...
class EventService(BaseService):
    ...
    def associate_ceremonies_to_event(self, event: Event, grand_final_date: datetime):
        ...
        CeremonyRepository(self.session).create_ceremony(ceremony_model_mapper.map_to_ceremony_entity(first_semifinal_ceremony))
        CeremonyRepository(self.session).create_ceremony(ceremony_model_mapper.map_to_ceremony_entity(second_semifinal_ceremony))
        CeremonyRepository(self.session).create_ceremony(ceremony_model_mapper.map_to_ceremony_entity(grand_final_ceremmony))
