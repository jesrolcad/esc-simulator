...
class EventApiMapper:
    ...
    def map_to_event_data_response(self, event_model: Event)->EventDataResponse:
        ceremonies = []
        for ceremony in event_model.ceremonies:
            ...
            ceremonies.append(CeremonyWithoutEventDataResponse(id=ceremony.id, date=ceremony.date, ceremony_type=ceremony_type, songs=songs, votings=votings))
